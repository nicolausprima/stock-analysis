 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "import numpy as np\n",
    "from dashboard.backend.yf_client import download_with_timeout  # S-6: timeout 25 dtk\n",
    "from pathlib import Path\n",
    "\n",
 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "from sklearn.metrics import f1_score  # S-6: sweep threshold val\n",
    "\n",
    "# Set project root path\n",
    "PROJECT_ROOT = Path('.').resolve().parent\n",
    "if str(PROJECT_ROOT) not in sys.path:\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# S-6: threshold operasi dari model_card (fallback 0.5)\n",
    "import json\n",
    "card = json.loads((PROJECT_ROOT / 'models' / 'model_card.json').read_text())\n",
    "thr = float(card.get('decision_threshold', 0.5))\n",
    "print(f\"Decision threshold operasi: {thr:.2f}\")\n",
